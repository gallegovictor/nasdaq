...
col_list_2W_43 = MyUtils.get_all_smallest(r_dict_2W_14, 59)
...
for i in range(0,183):
  ...
  if limit < 18750:
    reg=LinearRegression().fit(X[col_list_2W_43][(6250+i*125):(6250+374+i*125)], y[(6250+i*125):(6250+374+i*125)])
    #print(reg.score(X[col_list][(2787+125*i+250):(5574+125*i+374)], y[(5574+125*i+250):(5574+125*i+374)]))
    my_weights = MyUtils.solver(X[col_list_2W_43][(6250+i*125):(6250+374+i*125)], y[(6250+i*125):(6250+374+i*125)])
...
with open('/home/victor/Documentos/GitHub/nasdaq/3_weeks_unsup/3W_59_random.pickle', 'wb') as handle:
